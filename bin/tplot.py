...
parser.add_argument('-temp', '--temperature', action='store_true',
                    help='''
                    Generate a density-weighted gas temperature map
                    ''')
...
parser.add_argument('-sf', '--starformation', action='store_true',
                    ...
                    (with an underlying column density map of the gas surface
                    density)
                    ''')
parser.add_argument('-sa', '--stellarage', action='store_true',
                    help='''
                    Generate a map showing the stellar age of newly formed
                    star particles (with an underlying column density map of
...
parser.add_argument('-bhevol', '--bhevolution', action='store_true',
                    ...
                    of various properties for the central black hole sink
                    particle
                    ''')
...
if args.snapshot:
    v = TerminalPlot(file=args.snapshot, style=args.mplstyle,
                     ...
                     unit_for_length=args.ulength, show=args.show)

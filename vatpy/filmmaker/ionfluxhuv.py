...
def plot_ionfluxhuv(start, end):
    ...
    for i in range(start, end+1):
        ...
        # Gaseous component:
        quantity = ['mass', 'temp', 'F136', 'F152', 'F246']
        ...
        # Figure:
        fig, ax = plt.subplots(6, 5, figsize=(16, 16*(4.5/5)),
        ...
        # Time:
        ax[0, 4].text(1, 1, f'{time:.2f} Myr', fontsize='medium', color='k',
        ...
        # Freq. bins:
        ax[0, 2].text(0.95, 0.05, '13.6+ eV', fontsize='small', color='w',
                      ha='right', va='bottom', transform=ax[0, 2].transAxes)
        ax[0, 3].text(0.95, 0.05, '15.2+ eV', fontsize='small', color='w',
                      ha='right', va='bottom', transform=ax[0, 3].transAxes)
        ax[0, 4].text(0.95, 0.05, '24.6+ eV', fontsize='small', color='w',
                      ha='right', va='bottom', transform=ax[0, 4].transAxes)

        fig.savefig(f'./vframes/ionfluxhuv/ionfluxhuv_{snap}.png')
        plt.close()
